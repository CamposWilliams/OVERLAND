...
public class PatrullarVomet : MonoBehaviour
{
    ...
    private void OnTriggerStay2D(Collider2D collision)
    {
        if (collision.CompareTag("Player"))
        {
            ...
            GetComponent<SeguirAstarVomet>().MikeTrf = GameObject.Find("Mike").transform;
    ...
    private void OnTriggerExit2D(Collider2D collision)
    {
        if (collision.CompareTag("Player"))
        {
            ...
            GetComponent<SeguirAstarVomet>().MikeTrf = puntosMovimiento[0];
